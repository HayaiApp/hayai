...
| Library content selector, shortcuts, and migration compatibility | Typed content policy with an always-visible All/Manga/Novels selector in the J2K Library toolbar; shared Manga/Novel migration sections; catalogue-wide novel targets; atomic progress, quote, word-count, and highlight transfer | selector persistence and migration mapping/copy/conflict behavior covered by focused tests; end-to-end library and migration emulator flows pending |
