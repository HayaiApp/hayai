...
class RepoController(
    ...
    constructor(contentKind: ContentKind) : this(
        Bundle().apply { putString(CONTENT_KIND, contentKind.name) },
    )

    private val contentKind = bundle?.getString(CONTENT_KIND)?.let(ContentKind::valueOf) ?: ContentKind.Manga
     ...
     */
    private val presenter = RepoPresenter(this, contentKind)

    /**
     * Returns the toolbar title to show when this controller is attached.
     */
    override fun getTitle(): String? =
        resources?.getString(if (contentKind == ContentKind.Novel) R.string.hayai_novel_extension_repos else R.string.extension_repos)
