...
class HtmlAssetRewriterTest {
    ...
    fun `srcset candidates sharing a url prefix that only differ by query are not corrupted`() {
        val map = mapOf(
            "image_20.jpg" to "hayai-novel-image://image_20.jpg",
            "image_20.jpg?w=106&h=150" to "hayai-novel-image://image_20_thumb.jpg",
        )
        val out = HtmlAssetRewriter.rewriteHtml(
            """<img srcset="image_20.jpg 1443w, image_20.jpg?w=106&h=150 106w">""",
        ) { map[it] }
        assertEquals(
            """<img srcset="hayai-novel-image://image_20.jpg 1443w, """ +
                """hayai-novel-image://image_20_thumb.jpg 106w">""",
            out,
        )
    }
