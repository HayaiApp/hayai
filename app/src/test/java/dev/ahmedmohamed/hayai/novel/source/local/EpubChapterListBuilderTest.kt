...
class EpubChapterListBuilderTest {
    ...
    fun `buildEpubChaptersFromToc preserves fragment-based chapters`() {
        ...
        val chapters = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/book/volume.epub",
    ...
    fun `buildEpubChaptersFromToc includes spine-only pages not in toc`() {
        ...
        val chapters = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/f451/f451.epub",
    ...
    fun `buildEpubChaptersFromToc handles multi-book EPUBs with repeating chapter titles`() {
        ...
        val chapters = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/throne-of-glass/volume1.epub",
    ...
    fun `buildEpubChaptersFromToc supports volume offsets for multi epub sorting`() {
        ...
        val volume2 = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/throne-of-glass/volume2.epub",
    ...
    fun `buildEpubChaptersFromToc three volumes with offsets produce non-colliding chapter numbers`() {
        fun buildVolume(volumeIndex: Int, fileStem: String): List<eu.kanade.tachiyomi.source.model.SChapter> {
            ...
            return buildEpubChaptersFromToc(
                chapterFileUrl = "local-novels/series/$fileStem.epub",
    ...
    fun `buildEpubChaptersFromToc emits spine pages when toc is empty`() {
        val chapters = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/no-toc-book/novel.epub",
    ...
    fun `running offset across volumes produces gapless contiguous chapter numbers`() {
        ...
        val volume1 = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/series/001 - vol1.epub",
        ...
        val volume2 = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/series/002 - vol2.epub",
        ...
        val volume3 = buildEpubChaptersFromToc(
            chapterFileUrl = "local-novels/series/003 - vol3.epub",
